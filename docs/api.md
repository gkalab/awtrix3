...
| `icon` | string | The icon ID or filename (without extension) to display on the app. You can also send an **8x8 jpg** or an **8x8 bmp (16-bit RGB 5/6/5)** as Base64 String | N/A | X | X |
